...
export const ChaletHautContractPdf: React.FC<Props> = ({ data }) => {
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.rowFlex, { marginTop: 4 }]}>
            <View style={styles.value}>
              ...
              <Text style={styles.bulletItem}>1 chambre en mezzanine avec 3 lits simples (90)</Text>
              <Text style={styles.bulletItem}>1 pallier avec lit d'appoint (90)</Text>
          ...
          <Text style={{ marginTop: 8 }}>Les draps, serviettes et torchons sont fournis.</Text>
        </View>
